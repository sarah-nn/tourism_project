...
//   void roundPlaneList(BuildContext context, GoingAndReturnPlaneTrip something2,
...
//                 topLeft: Radius.circular(20), topRight: Radius.circular(20))),
//         builder: (BuildContext context) {
//           return RoundPlaneList(
//             roundList: something2,
//             start: start,
//             end: end,
//           );
//         });
...
//             elevation: 10,
//             onPressed: () async {
//               String start = context.read<DynamicTripCubit>().startDate;
//               String end = context.read<DynamicTripCubit>().endDate;
//               //! it sometimes make null exception
//               //! it is because of not choose time
//               //! buttom sheet have new tree widget
//               if (_selectedOption != null) {
...
//                       ? errMessage == ''
//                           ? roundPlaneList(
//                               context, goingAndReturnPlaneTrip!, start, end)
//                           : showAlertDialog(context, errMessage)
//                       : errMessage == ''
//                           ? singlePlaneList(context, planesList)
//                           : showAlertDialog(context, errMessage);
