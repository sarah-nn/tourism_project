...
//   int returnChoose = -1;
//   bool completBook = false;
//   List<ReturnTrip> filteredGoList = [];
//   List<GoingTrip> filteredreturnList = [];

//   void initState() {
//     filteredGoList = widget.roundList.data.returnTrip.where((trip) {
//       return trip.flightDate == widget.start;
//     }).toList();
//     filteredreturnList = widget.roundList.data.goingTrip.where((trip) {
//       return trip.flightDate == widget.end;
//     }).toList();
//     print('${widget.roundList.data.returnTrip[0].flightDate == widget.start}');

//     print("-----${filteredGoList}");
//     print("-----${filteredreturnList}");
//     super.initState();
//   }
...
//             child: ListView.builder(
//               itemCount: goOrReturn
//                   ? filteredGoList.length
//                   : filteredreturnList.length,
//               itemBuilder: (context, index) {
//                 return goOrReturn
//                     ? returnRoundCard(filteredGoList[index], index)
//                     : goingRoundCard(filteredreturnList[index], index);
//                 //! my pre code
//                 // return goOrReturn
//                 //     ? returnRoundCard(
//                 //         widget.roundList.data.returnTrip[index], index)
