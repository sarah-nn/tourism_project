...
//                 customRow('room price \$ ${model?.roomPrice} :',
//                     "\$ ${(model!.days * model!.roomPrice * model!.roomsNeeded)}"),
//                 customRow("going_plane \$ ${model?.ticketPriceForGoingTrip} :",
//                     "\$ ${model!.ticketPriceForGoingTrip * _counter}"),
//                 customRow(
//                     "return_plane \$ ${model?.ticketPriceForReturnTrip} :",
//                     "\$ ${model!.ticketPriceForReturnTrip * _counter}"),
//                 // customRow(
//                 //     headlines[4], "\$ ${model?.ticketPriceForReturnTrip}"),
//                 customRow("Place Price \$ ${model?.ticket_price_for_places} :",
...
//                       children: [
//                         model?.priceAfterDiscount != null
//                             ? const Text("Use Points To Pay")
//                             : const Text("Don't Have Enough Points"),
//                         const Icon(
