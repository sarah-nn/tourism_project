...
class CardPlaeBook extends StatefulWidget {
  CardPlaeBook(
      {required this.onDelete, required this.futureTripsPlane, super.key});
  final FutureTripsPlane futureTripsPlane;
...
class _CardPlaeBookState extends State<CardPlaeBook> {
  ...
  void initState() {
    super.initState();
    nameBooking = widget.futureTripsPlane.tripName;
    ...
    return BlocConsumer<ShowDetailsBookPlaneCubit, ShowDetailsBookPlaneState>(
      ...
      return Stack(
        ...
        children: [
              ...
              child: Padding(
                ...
                child: Column(
                    ...
                    children: [
                      ...
                      TextInfoBook(
                          baseText: 'start date',
                          secoundText: widget.futureTripsPlane.startDate),
                      const SizedBox(height: 10),
                      TextInfoBook(
                          baseText: 'end date',
                          secoundText: widget.futureTripsPlane.endDate),
                      !isExpanded
                          ? const SizedBox(height: 20)
                          : const SizedBox(height: 10),
                      !isExpanded
                          ? GestureDetector(
                              onTap: () {
                                ...
                                myBloc.getAllShowDetailsBookPlane(
                                    widget.futureTripsPlane.id.toString());
                              },
                              child: Text(
                                'view more details...',
                                style: TextStyle(
                          ...
                          GestureDetector(
                            onTap: () {
                              ...
                              date2 = DateTime.parse(
                                  widget.futureTripsPlane.startDate);
                                                  ...
                                                  onPressed: () {
                                                    myBloc.editBookPlane(
                                                        id: widget
                                                            .futureTripsPlane.id
                                                            .toString(),
                                                        //nameTrip: nameBooking,
                                                        numberOfPeople:
                                                            editNumPersone
                                                                .toString());
                                                    successEdit
                                                        ? setState(() {
                                                            widget.futureTripsPlane
                                                                    .tripName =
                                                                nameBooking;
                                                          })
                                                        : null;
          ...
          TextNameBook(
            name: widget.futureTripsPlane.tripName,
          )
        ],
      );
    });
